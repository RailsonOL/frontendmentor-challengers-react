...
export default function Header({ currentPage = 1 }: Props) {
      ...
      <nav className="ml-auto flex gap-8 font-['Barlow_Condensed'] uppercase text-white md:h-full md:w-[60%]">
        ...
        >
          <ul className="h-full items-center justify-center gap-10 max-sm:space-y-6 sm:flex lg:pr-32">
            <li
              className={`flex flex-col hover:border-b-white/50 md:h-full md:items-center md:justify-center md:hover:border-b-2 ${
                currentPage === 1 ? 'border-b-2 border-b-white' : ''
              }`}
            >
              <Link href="/space-tourism">
            ...
            <li
              className={`flex flex-col hover:border-b-white/50 md:h-full md:items-center md:justify-center md:hover:border-b-2 ${
                currentPage === 2 ? 'border-b-2 border-b-white' : ''
              }`}
            >
              <Link href="/space-tourism/destination">
            ...
            <li
              className={`flex flex-col hover:border-b-white/50 md:h-full md:items-center md:justify-center md:hover:border-b-2 ${
                currentPage === 3 ? 'border-b-2 border-b-white' : ''
              }`}
            >
              <a href="#">
            ...
            <li
              className={`flex flex-col hover:border-b-white/50 md:h-full md:items-center md:justify-center md:hover:border-b-2 ${
                currentPage === 4 ? 'border-b-2 border-b-white' : ''
              }`}
            >
              <a href="#">
